...
export const REALISTIC_CANARIAN_CAMPERS: DemoCamperItem[] = [
  ...
  // ANUNCIO 4: MINI CAMPER VAM HOT WATER (GRAN CANARIA)
  {
    id: 'mini-camper-vam-hot-water-7239a331',
    slug: 'mini-camper-vam-hot-water-7239a331',
    title: 'Mini Camper Vam Hot Water',
    brand: 'Hyundai',
    model: 'H1 Starex Custom Camper',
    vehicleType: 'TURISMO_CAMPERIZADO',
    year: 2023,
    island: 'Gran Canaria',
    municipality: 'Las Palmas de Gran Canaria',
    addressApprox: 'Las Palmas de Gran Canaria / Guanarteme',
    latitude: 28.1235,
    longitude: -15.4362,
    passengers: 2,
    beds: 2,
    ...
    isDemoVehicle: true,
    isFeatured: true,
    description: 'Mini Camper completamente equipada para recorrer Gran Canaria con total libertad. Cuenta con sistema de ducha con agua caliente, cama doble muy cómoda, cocina de gas, nevera, toldo lateral y todo el menaje necesario. Ágil y fácil de conducir y aparcar en cualquier playa o mirador.',
    rules: 'No fumar en el interior. Mascotas permitidas bajo consulta previa. Devolver con el depósito de combustible lleno.',
    owner: {
      id: 'owner-alejandro-4',
      firstName: 'Alejandro',
      lastName: 'González',
    ...
    photos: [
      ...
      { id: 'p4-2', url: '/Anuncios/3/foto-2.png', orderIndex: 1 },
      { id: 'p4-3', url: '/Anuncios/3/foto-3.png', orderIndex: 2 },
    ],
    features: [
      { id: 'f4-1', name: 'Ducha con sistema de agua caliente' },
      { id: 'f4-2', name: 'Cama doble interior confortable' },
      { id: 'f4-3', name: 'Nevera y cocina de gas con menaje' },
      { id: 'f4-4', name: 'Kit de sillas y mesa de camping' },
      { id: 'f4-5', name: 'Oscurecedores y aislantes térmicos' },
      { id: 'f4-6', name: 'Conexiones USB y 12V' },
    ],
    reviews: [
      {
        id: 'r4-1',
        rating: 5,
        comment: '¡Increíble experiencia con la Mini Camper! El agua caliente es un lujo después de un día de playa en Agaete. Alejandro súper atento y puntual en la entrega.',
        author: { firstName: 'Laura Sánchez', avatarUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=120' },
      },
    ],
  },
];
