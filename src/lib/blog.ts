...
export const BLOG_ARTICLES: BlogArticle[] = [
  ...
  },
  {
    ...
    image: 'https://alisiospicnic.es/og-image.webp', publishedAt: '2026-08-26', readingTime: '6 min', keywords: ['camper y picnic Gran Canaria', 'picnic romántico Gran Canaria'],
    sections: [
  ...
  },
  {
    ...
    image: 'https://alisiospicnic.es/og-image.webp', publishedAt: '2026-08-26', readingTime: '5 min', keywords: ['Finca Alisios picnic', 'escapada romántica camper'],
    sections: [
  ...
  },
  {
    ...
    image: 'https://alisiospicnic.es/og-image.webp', publishedAt: '2026-08-26', readingTime: '6 min', keywords: ['Gran Canaria en camper', 'experiencias locales Canarias'],
    sections: [
