...
export default function AdminVerificationQueue() {
  ...
  return <section className="mt-10 rounded-3xl border border-[#E9E1D2] bg-white p-6 shadow-sm">
    <div className="mb-4 flex flex-wrap items-center justify-between gap-3"><div><h2 className="text-2xl font-bold tracking-tight">Documentos pendientes de revisión</h2><p className="text-xs text-[#6B726E]">Los originales cifrados solo se descifran para la persona titular y administración.</p></div><button type="button" onClick={() => void load()} className="flex items-center gap-2 rounded-full border border-[#E9E1D2] px-4 py-2 text-xs font-bold"><RefreshCw className="h-4 w-4" />Actualizar</button></div>
