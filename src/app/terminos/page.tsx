    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#0F172A]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-3xl p-8 border border-[#E2E8F0] shadow-sm space-y-6">
          ...
          <div className="space-y-4 text-xs text-[#64748B] leading-relaxed font-medium">
            <h3 className="font-serif text-lg font-bold text-[#0F172A]">1. Coberturas de Seguro y Responsabilidad del Vehículo</h3>
            <p>
            ...
            <h3 className="font-serif text-lg font-bold text-[#0F172A]">2. Fianza de Cobertura y Franquicias</h3>
            <p>
