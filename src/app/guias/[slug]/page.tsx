      ...
      <main>
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <header className="mt-4 mb-10">
            ...
            <p className="text-xl text-[#4A5568] leading-relaxed font-serif italic border-l-4 border-[#16B8AA] pl-4 py-1">
              {article.excerpt}
            </p>
          </header>

          <div className="relative mb-12 rounded-3xl overflow-hidden shadow-lg border border-[#E9E1D2]">
