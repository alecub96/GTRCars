  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#0F172A]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-[#E2E8F0] shadow-xl space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-3xl bg-[#F4F9F8] border border-[#E2E8F0] space-y-3">
              <div className="w-10 h-10 rounded-2xl bg-[#14B8A6] text-white flex items-center justify-center font-bold">
                1
              </div>
              <h3 className="font-serif text-xl font-bold text-[#0F172A]">Seguro de la Camper</h3>
            ...
            <div className="p-6 rounded-3xl bg-amber-50/60 border border-amber-200/80 space-y-3">
              ...
              <h3 className="font-serif text-xl font-bold text-[#0F172A]">Fianza de Garantía</h3>
