    ...
    images: [
      {
        ...
        height: 630,
        type: 'image/png',
        alt: 'GTR Cars — Alquiler de Superdeportivos en Madrid, Barcelona, Canarias y Londres',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'GTR Cars | International Supercar & Hypercar Club',
    description: 'Alquiler exclusivo de deportivos, superdeportivos e hypercars en Gran Canaria, Tenerife, Madrid, Barcelona y Londres.',
    images: ['/og-image.png'],
  },
  robots: {
    index: true,
