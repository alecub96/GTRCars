...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'La plataforma líder en las Islas Canarias para alquilar campers, autocaravanas y 4x4 entre particulares. Directo con propietarios locales verificados, 0% comisiones abusivas y contrato digital.',
