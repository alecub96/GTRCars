...
export const metadata: Metadata = {
  title: 'Alquila tu camper en Canarias y genera ingresos | Vaneando',
  description: 'Publica tu camper, autocaravana o furgoneta en Canarias. Gestiona calendario, reservas y cobros protegidos con una comisión del 9,7%.',
    ...
    <div className="min-h-screen bg-[#F7F6F2] text-[#13322E]"><Navbar />
      <main>
        <section className="bg-[#13322E] px-4 py-16 text-white sm:py-24"><div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_.9fr]">
          <div><span className="text-xs font-black uppercase tracking-[.25em] text-[#F2CC8F]">Para propietarios de Canarias</span><h1 className="mt-4 max-w-3xl font-serif text-4xl font-bold leading-tight sm:text-6xl">¿Tienes una camper parada? Empieza a generar ingresos.</h1><p className="mt-6 max-w-2xl text-lg leading-8 text-white/80">Publica tu camper, autocaravana o furgoneta en una plataforma local. Tú decides el precio, las fechas y las condiciones; Vaneando te ayuda a encontrar viajeros y gestionar la reserva.</p><div className="mt-8 flex flex-wrap gap-3"><Link href="/publicar-camper" className="inline-flex items-center gap-2 rounded-full bg-[#16B8AA] px-6 py-3 text-sm font-black text-white hover:bg-[#0F766E]">Publica tu camper gratis <ArrowRight className="h-4 w-4" /></Link><Link href="#como-funciona" className="rounded-full border border-white/30 px-6 py-3 text-sm font-bold text-white hover:bg-white/10">Cómo funciona</Link></div></div>
