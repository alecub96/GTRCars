    ...
    <div className="min-h-screen bg-white text-black selection:bg-black selection:text-white flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 w-full">
        ...
        <section className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center space-x-2 bg-gray-100 text-black border border-gray-200 px-4 py-1.5 rounded-full text-[10px] font-mono font-bold uppercase tracking-widest">
          ...
          <p className="text-xs sm:text-sm text-gray-500 font-mono leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 items-center">
          ...
          <div className="bg-gray-50 rounded-3xl p-6 sm:p-8 border border-gray-200 shadow-2xl space-y-4">
            <div className="grid grid-cols-2 gap-4 text-center font-mono">
              <div className="p-4 rounded-2xl bg-gray-100 border border-gray-200">
                <strong className="block font-serif text-3xl font-bold text-black">800+ CV</strong>
                <span className="text-[10px] font-bold text-gray-500 uppercase">Hypercars V8 / V12</span>
              </div>
              <div className="p-4 rounded-2xl bg-gray-100 border border-gray-200">
                <strong className="block font-serif text-3xl font-bold text-black">100%</strong>
                <span className="text-[10px] font-bold text-gray-500 uppercase">Inspección Oficial</span>
              </div>
              <div className="p-4 rounded-2xl bg-gray-100 border border-gray-200">
                <strong className="block font-serif text-3xl font-bold text-black">24/7</strong>
                <span className="text-[10px] font-bold text-gray-500 uppercase">Concierge VIP</span>
              </div>
              <div className="p-4 rounded-2xl bg-gray-100 border border-gray-200">
                <strong className="block font-serif text-3xl font-bold text-black">&lt; 5 min</strong>
                <span className="text-[10px] font-bold text-gray-500 uppercase">Entrega en Aeropuerto</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="mb-16">
          <div className="text-center max-w-xl mx-auto mb-10">
            ...
            <p className="text-xs font-mono text-gray-500 mt-1">Garantía de rendimiento, seguridad y discreción.</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-gray-50 rounded-3xl p-6 border border-gray-200 shadow-xl space-y-3">
              <div className="h-10 w-10 rounded-2xl bg-gray-100 text-black border border-gray-200 flex items-center justify-center font-bold">
        ...
        {/* BANNER FINAL CTA */}
        <div className="bg-gradient-to-br from-[#17171d] via-[#101014] to-black text-white rounded-3xl p-8 sm:p-12 text-center shadow-2xl border border-gray-200 space-y-5">
          ...
          <p className="text-xs sm:text-sm text-gray-500 max-w-md mx-auto font-mono">
            Explora nuestra flota y reserva tu Ferrari, Lamborghini, McLaren o Porsche con confirmación directa.
          </p>
          <div className="pt-2">
            <Link
              href="/#flota"
              className="inline-flex items-center space-x-2 rounded-xl bg-black text-white hover:bg-neutral-800 px-8 py-3.5 text-xs font-mono font-bold uppercase tracking-widest transition-all shadow-lg hover:brightness-110 active:scale-95 cursor-pointer"
            >
