...
export const metadata = {
  ...
  description: 'Descubre colaboradores locales que mejoran tu experiencia viajando por Canarias en camper.',
  alternates: { canonical: 'https://vaneando.com/colaboradores' },
};
