...
const sections = [
  ...
  ['2. Datos que tratamos', <>Podemos tratar datos identificativos y de contacto, credenciales, perfil, documentación de verificación, datos de conducción, información de reservas, comunicaciones dentro de la plataforma, datos de pago gestionados por proveedores financieros y datos técnicos de navegación. Solo solicitamos los datos necesarios para cada función.</>],
  ['3. Para qué utilizamos tus datos', <>Usamos la información para crear y proteger tu cuenta, conectar viajeros y propietarios, gestionar solicitudes y contratos, procesar pagos y reembolsos, verificar documentación, atender soporte, prevenir fraude, enviar avisos transaccionales y mejorar la plataforma. No vendemos datos personales.</>],
  ...
  ['6. Verificaciones y documentos', <>Los documentos aportados para verificar identidad, permiso de conducción o titularidad se almacenan con controles de acceso y cifrado cuando la configuración lo permite. El equipo autorizado podrá revisarlos para aprobar una cuenta o una reserva. No publiques documentos en chats ni perfiles.</>],
