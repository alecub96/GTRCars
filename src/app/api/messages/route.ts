...
// "at" debe ser una palabra independiente; sin límites provocaba falsos positivos
// en palabras normales como "plataforma".
const AT_SPELLED_REGEX = /\b(arroba|at|gmail|hotmail|yahoo|outlook|icloud)\b/i;
